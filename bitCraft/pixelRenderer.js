...
const PixelRenderer = {
    ...
    patterns: {
        ...
        goblin: function(ctx, x, y, size, color) {
            const pixelSize = GameConfig.graphics.pixelSize;
            ...
            ctx.fillRect(x - size/3, y - size/3, pixelSize * 2, pixelSize);
            ctx.fillRect(x + size/6, y - size/3, pixelSize * 2, pixelSize);
            
            // Teeth (white)
            ctx.fillStyle = '#ffffff';
            ctx.fillRect(x - size/4, y + size/6, pixelSize, pixelSize);
            ctx.fillRect(x + size/8, y + size/6, pixelSize, pixelSize);
        },
