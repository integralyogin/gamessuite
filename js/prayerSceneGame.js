...
const PrayerSceneGame = {
    ...
    availableImages: [
        'images/saint_in_prayer/saint-in-prayer0.jpg', 'images/saint_in_prayer/saint-in-prayer11.jpg',
        'images/saint_in_prayer/saint-in-prayer4.jpg', 'images/saint_in_prayer/saint-in-prayer8.jpg',
        'images/saint_in_prayer/saint-in-prayer10.jpg', 'images/saint_in_prayer/saint-in-prayer3.jpg',
        'images/saint_in_prayer/saint-in-prayer1.jpg', 'images/saint_in_prayer/saint-in-prayer2.jpg',
        'images/saint_in_prayer/saint-in-prayer5.jpg', 'images/saint_in_prayer/saint-in-prayer6.jpg',
        'images/saint_in_prayer/saint-in-prayer9.jpg', 'images/saint_in_prayer/saint-in-prayer12.jpg',
        'images/saint_in_prayer/saint-in-prayer13.jpg', 'images/saint_in_prayer/saint-in-prayer14.jpg',
        'images/saint_in_prayer/saint-in-prayer15.jpg', 'images/saint_in_prayer/saint-in-prayer7.jpg'
    ],
    currentImageIndex: 0,
    ...
    animationSettings: {
        ...
        peakContrast: 1.13, peakHueShift: 580, peakScale: 1.44,
    ...
    phaseDurationSeconds: 4, // Default duration for one phase
    ...
    init: function(container, successCallback, failureCallback, sharedData) {
        ...
        if (this.availableImages.length > 0 && !this.imageUrl) {
            ...
            this.imageUrl = 'images/saint_in_prayer/default_placeholder.png';
        }
    ...
    _injectStyles: function() {
        ...
        this.styles.innerHTML = `
            ...
            .prayer-controls-container { position: absolute; top: 15px; right: 15px; z-index: 10; display: flex; flex-direction: column; gap: 10px; align-items: flex-end; }
            ...
            #prayerImageElementFocused {
                display: block; margin-top: 135px; margin-bottom: 15px; border: 4px solid #251838;
    ...
    _handleImageError: function() {
        ...
        this._updateImageSource('images/saint_in_prayer/default_placeholder.png', "Image failed to load. Check URL or select another.");
    ...
    _validateAndLoadImageUrl: function(url) {
        ...
        if (!/^(https?:\/\/|images\/)/i.test(newUrl)) { // Basic check for http(s) or local 'images/saint_in_prayer/'
            console.warn("PrayerSceneGame: Invalid URL or path format for:", newUrl);
            if (this.elements.imageUrlInput) this.elements.imageUrlInput.style.borderColor = 'orange';
            if (this.elements.message && !this.elements.message.dataset.isError) this.elements.message.textContent = "Invalid URL format. Must start with http(s):// or be local like images/saint_in_prayer/name.jpg.";
            return false;
        }
